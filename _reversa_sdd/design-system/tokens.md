# Design Tokens — sistema legado (tabela mestra)
...
```
index.css (:root / .dark)     ← hexes de cor (fonte de verdade)
        ↓ var(--*)
design-tokens.ts              ← ponte colors + spacing/radii/font literais
        ↓
tailwind.config.ts            ← utilitários (bg-bg, p-md, rounded-md, font-mono)
        ↓
