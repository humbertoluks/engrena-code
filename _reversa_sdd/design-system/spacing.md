# Spacing, Grid & Breakpoints — sistema legado

> Fonte: `packages/renderer/src/tokens/design-tokens.ts` + `tailwind.config.ts`. Confiança: 🟢 (escala) | 🟡 (breakpoints = Tailwind default)
...
Extendido em `theme.extend.spacing` (não substitui a escala default do Tailwind; coexiste com `p-1`, `p-2`, etc.).
...
| ----- | ----- | --------- |
| sm / md / lg / xl / 2xl | Tailwind defaults (640 / 768 / 1024 / 1280 / 1536) | 🟡 não customizados em `tailwind.config.ts` |
