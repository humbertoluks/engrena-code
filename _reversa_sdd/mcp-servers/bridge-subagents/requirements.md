...
- `SISTEMA_LEGADO_SUBAGENTS` = catálogo `[{name,description}]`; enum restringe nomes 🟢
...
| RF-07 | Injeção Codex via TOML mcp_servers.sistema-legado | Should | command+args dist/index.js |
...
|---------|-------|-----------|
| `mcp-servers/sistema-legado-subagents/src/index.ts` | Registro tools MCP | 🟢 |
| `mcp-servers/sistema-legado-subagents/src/protocol.ts` | Config + proxies | 🟢 |
| `mcp-servers/sistema-legado-subagents/test/protocol.test.ts` | Testes puros | 🟢 |
